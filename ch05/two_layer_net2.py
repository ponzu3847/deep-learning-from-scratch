...
class TwoLayerNet2:
    ...
    def __init__(self, input_size, hidden_size, output_size,initial_val=0.01):
        # 重みの初期化
        self.params = {}
        self.params['b1'] = np.zeros(hidden_size)
        self.params['b2'] = np.zeros(output_size)

        if initial_val=='Xavier':
            ...
            self.params['W1'] = initial_val * np.random.randn(input_size, hidden_size)
            self.params['W2'] = initial_val * np.random.randn(hidden_size, output_size) 
